...
* I struggled with making sure the if and else statements returned the correct values because I remeber firstly writting the code opposite so it would return the wrong number at first but then I realized my mistake and fixed it.
